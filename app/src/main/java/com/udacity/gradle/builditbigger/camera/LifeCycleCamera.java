...
import com.udacity.gradle.builditbigger.signInOnboarding.profilePicture.ProfilePictureFragment;
...
public class LifeCycleCamera implements LifecycleObserver, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public LifeCycleCamera(Fragment fragment, AutoFitTextureView aftv, int mode, boolean isBackCamera) {
        this.fragment = fragment;
        mTextureView = aftv;
        this.fragment.getLifecycle().addObserver(this);
        this.mode = mode;
    ...
    public LifeCycleCamera(Fragment fragment, AutoFitTextureView aftv, int mode, boolean isBackCamera, boolean lookForFace) {
        this.fragment = fragment;
        mTextureView = aftv;
        this.fragment.getLifecycle().addObserver(this);
        this.mode = mode;
        this.isBackCamera = isBackCamera;
        this.lookForFace = lookForFace;
    }
