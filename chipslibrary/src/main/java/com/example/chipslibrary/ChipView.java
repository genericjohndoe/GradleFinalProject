...
import com.example.chipslibrary.databinding.ChipViewBinding;
...
public class ChipView extends RelativeLayout {
    //todo relativelayout vs constraintlayout?
    ...
    private void init(AttributeSet attrs) {
        // inflate layout
        binding = DataBindingUtil.bind(inflate(getContext(), R.layout.chip_view, this));
    ...
    public static class Builder {
        ...
        private boolean deletable = false;//todo may want to change to true
