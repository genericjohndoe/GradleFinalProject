package com.example.chipslibrary.adapters;
...
import com.example.chipslibrary.ChipView;
...
public class ChipsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //todo is using hash code performant or the best practice?
    @Override
    ...
    private void initEditText() {
        //todo set as default values in edittext
        ...
        mEditText.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                // TODO may get called multiple times, may want to replace with ACTION_UP
    ...
    private void autofitEditText() {
        //todo does this method do what it says?
    ...
    private void handleClickOnEditText(ChipView chipView, final int position) {
        // delete chip
        chipView.setOnDeleteClicked(view -> removeChip(position));
